# Создаем пошаговое руководство по работе с Draw.io для студентов
...
with open('drawio_step_by_step_guide.md', 'w', encoding='utf-8') as f:
    f.write(drawio_guide)

print("=== СОЗДАНО ПОДРОБНОЕ РУКОВОДСТВО ПО DRAW.IO ===")
print("Файл: drawio_step_by_step_guide.md")
print("\nРуководство включает:")
print("✓ Пошаговые инструкции по созданию ER-диаграммы")
print("✓ Детальное описание интерфейса Draw.io")
print("✓ Правила работы с нотацией Crow's Foot")
print("✓ Советы по оформлению и лучшие практики")
print("✓ Инструкции по сохранению и экспорту")
print("✓ Контрольный список для проверки")
print("✓ Альтернативные инструменты")
print("✓ Типичные ошибки и способы их избежания")